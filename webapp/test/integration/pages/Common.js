sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("ControlTaskVolovik/ControlTaskVolovik/app", ".html");
		...
		return Opa5.extend("ControlTaskVolovik.ControlTaskVolovik.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["ControlTaskVolovik/ControlTaskVolovik/localService/mockserver"], function (mockserver) {
